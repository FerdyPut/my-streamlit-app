...
import pytz
st.set_page_config(page_title="Form Survey Promo HCO Chain dan Lokal - Siantar Top - BSI ", page_icon=":bookmark_tabs:", layout="centered",initial_sidebar_state = "collapsed")
